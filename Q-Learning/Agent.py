...
class Agent:
    ...
    def save_data(self, list_index):
        # Save Data Q-Matrix
        try:
            df1 = pd.read_csv('/home/rizky/q_learning/'+'Q_Matrix_1.csv')
            df2 = pd.read_csv('/home/rizky/q_learning/'+'Q_Matrix_2.csv')
            df3 = pd.read_csv('/home/rizky/q_learning/'+'Q_Matrix_3.csv')
            ...
            q_matrix_1.to_csv('/home/rizky/q_learning/'+'Q_Matrix_1.csv', sep = ',', index = False)
            q_matrix_2.to_csv('/home/rizky/q_learning/'+'Q_Matrix_2.csv', sep = ',', index = False)
            q_matrix_3.to_csv('/home/rizky/q_learning/'+'Q_Matrix_3.csv', sep = ',', index = False)

        except FileNotFoundError:
            for i in range(len(self.Q_matrix)):
                pd.DataFrame(self.Q_matrix[i], columns = list_index).to_csv('/home/rizky/q_learning/'+'Q_Matrix_'+str(i+1)+'.csv', sep = ',', index = False)

        try:
            q_val11 = pd.read_csv('/home/rizky/q_learning/'+'qval_11.csv').to_numpy()
            q_val12 = pd.read_csv('/home/rizky/q_learning/'+'qval_12.csv').to_numpy()
            q_val13 = pd.read_csv('/home/rizky/q_learning/'+'qval_13.csv').to_numpy()
            q_val14 = pd.read_csv('/home/rizky/q_learning/'+'qval_14.csv').to_numpy()
            q_val15 = pd.read_csv('/home/rizky/q_learning/'+'qval_15.csv').to_numpy()
            q_val16 = pd.read_csv('/home/rizky/q_learning/'+'qval_16.csv').to_numpy()
            q_val21 = pd.read_csv('/home/rizky/q_learning/'+'qval_21.csv').to_numpy()
            q_val22 = pd.read_csv('/home/rizky/q_learning/'+'qval_22.csv').to_numpy()
            q_val23 = pd.read_csv('/home/rizky/q_learning/'+'qval_23.csv').to_numpy()
            q_val24 = pd.read_csv('/home/rizky/q_learning/'+'qval_24.csv').to_numpy()
            q_val25 = pd.read_csv('/home/rizky/q_learning/'+'qval_25.csv').to_numpy()
            q_val26 = pd.read_csv('/home/rizky/q_learning/'+'qval_26.csv').to_numpy()
            q_val31 = pd.read_csv('/home/rizky/q_learning/'+'qval_31.csv').to_numpy()
            q_val32 = pd.read_csv('/home/rizky/q_learning/'+'qval_32.csv').to_numpy()
            q_val33 = pd.read_csv('/home/rizky/q_learning/'+'qval_33.csv').to_numpy()
            q_val34 = pd.read_csv('/home/rizky/q_learning/'+'qval_34.csv').to_numpy()
            q_val35 = pd.read_csv('/home/rizky/q_learning/'+'qval_35.csv').to_numpy()
            q_val36 = pd.read_csv('/home/rizky/q_learning/'+'qval_36.csv').to_numpy()
            ...
            for i in range(3):
                for j in range(6):
                    ...
                    qval.to_csv('/home/rizky/q_learning/'+self.name_val[6*i+j]+'.csv', index = False)
            ...
            for i in range(3):
                for j in range(6):
                    ...
                    q_val.to_csv('/home/rizky/q_learning/'+self.name_val[6*i+j]+'.csv', index = False)            
        ...
        try:
            state_action_1 = pd.read_csv('/home/rizky/q_learning/'+'state_action_1.csv')
            state_action_2 = pd.read_csv('/home/rizky/q_learning/'+'state_action_2.csv')
            state_action_3 = pd.read_csv('/home/rizky/q_learning/'+'state_action_3.csv')
            ...
            update_state_action_1.to_csv('/home/rizky/q_learning/'+'state_action_1.csv', index = False)
            update_state_action_2.to_csv('/home/rizky/q_learning/'+'state_action_2.csv', index = False)
            update_state_action_3.to_csv('/home/rizky/q_learning/'+'state_action_3.csv', index = False)

        except FileNotFoundError:
            new_state_action_1.to_csv('/home/rizky/q_learning/'+'state_action_1.csv', index = False)
            new_state_action_2.to_csv('/home/rizky/q_learning/'+'state_action_2.csv', index = False)
            new_state_action_3.to_csv('/home/rizky/q_learning/'+'state_action_3.csv', index = False)